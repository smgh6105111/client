...
list=ttk.Treeview(frame3,columns=(1,2,3,4),show='headings',height=6,yscrollcommand=scroll.set,xscrollcommand=scroll2.set)
scroll.config(command=list.yview)
scroll2.config(command=list.xview)
list.pack()
list.heading(1,text="USER NAME")
list.heading(2,text="PASSWORD")
list.heading(3,text="E MAIL")
list.heading(4,text="GENDER")
list.column(1,width=200)
list.column(2,width=200)
list.column(3,width=200)
list.column(4,width=200)
displaytime()
displaydate()
root.mainloop()